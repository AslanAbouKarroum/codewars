...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
    let month_num = 0;
    let left_over = startPriceOld - startPriceNew;
    let savings = 0;
    while(left_over<0){
        month_num++;
        savings = savings + savingperMonth;
        if(month_num%2==0) percentLossByMonth = percentLossByMonth + 0.5;
        ...
        left_over = startPriceOld - startPriceNew + savings;
    };
    return [month_num, Math.round(left_over)];
};
