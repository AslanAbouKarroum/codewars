        ...
        switch (moves[i]){
            case 'up' : {
                if(position[0]==0 || fighters[position[0]-1][position[1]] == ''){
                    solution.push(fighters[position[0]][position[1]]) 
                }else{
                    solution.push(fighters[position[0]-1][position[1]]) 
            ...
            case 'right' : {
                if(position[1]+1 < fighters[position[0]].length){
                    if(fighters[position[0]][position[1]+1]!= ''){
                        solution.push(fighters[position[0]][position[1]+1])
                    }else{
                        --i;
                    }
                    ...
                    if(fighters[position[0]][0]!= ''){
                        solution.push(fighters[position[0]][0])
                    }else{
                        --i;
                    }
            ...
            case 'left' : {
                if(position[1] > 0){
                    ...
                    if(fighters[position[0]][fighters[position[0]].length-1]!= ''){
                        solution.push(fighters[position[0]][fighters[position[0]].length-1])
                    }else{
                        --i;
                    }
                    position = [position[0],fighters[position[0]].length-1]
                }
                break;
            }
        }
